#!/bin/bash
#####################################################################################################
# Script_Name : xrdp-installer-1.5.4.sh
...
#                 - Code cleanup  
#         : 1.5.3 - additional check not to install xrdp standard on ubuntu 24.10 (cause incompatible version)
...
/bin/echo -e "\e[1;36m   !   Written by Griffon - April    2025  -  www.c-nergy.be         !\e[0m"
/bin/echo -e "\e[1;36m   !                                                                 !\e[0m"
...
array=("Ubuntu 22.04" "Ubuntu 24.04" "Ubuntu 24.10" "Ubuntu 25.04" "Pop!_OS 20.04" "Pop!_OS 22.04" "Debian" "Mint" "LMDE" "Zorin" "elementary OS")
...
then 
    ...
    echo 
	    ...
	    /bin/echo -e "\e[1;31m  ! Ubuntu 25.04.x/22.04/24.04/Debian 11/12                      !\e[0m"
...
## Image in xRDP Login Credentials - All versions
#if [[ *"$version"* = *"Debian"*  ]]
#then
#	CustomPix="griffon_logo_xrdpd.bmp"
#else 
	CustomPix="griffon_nlogo_xrdp.bmp"
#fi
...
#Install packages (adding openh264 support)
...
#-- check if no error during downloads process 
if [ $? -eq 0 ]
then 
/bin/echo -e "\e[1;33m   |-| xrdp sources Download successfully       \e[0m"
else 
echo
echo
/bin/echo -e "\e[1;31m   !---------------------------------------------!\e[0m"
/bin/echo -e "\e[1;31m   !   Error while Downloading sources           !\e[0m"
/bin/echo -e "\e[1;31m   !   The Script is exiting....                 !\e[0m"
/bin/echo -e "\e[1;31m   !---------------------------------------------!\e[0m"
exit
fi
...
sudo sed -i 's/blue=009cb5/blue=333333/' /etc/xrdp/xrdp.ini
sudo sed -i 's/#white=ffffff/white=ffffff/' /etc/xrdp/xrdp.ini
